          ...
          <div className="home-main">
            <div className="home-content-main">
              ...
              <div className="home-content">
                StakeYard aims to become a medium of revolutionary DeFi where a
                user can stake some amount of tokens in a pool and gain not just
                interest for the staked tokens but a subscription of their
                choice too
              </div>
